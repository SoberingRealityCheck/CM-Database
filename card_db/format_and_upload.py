...
def jsonFileUploader(fname):
    ...
    filename_url = fname[62:][:19]
    shortened_url = filename_url[:4] + filename_url[5:7] + filename_url[8:10] + filename_url[11:13] + filename_url[14:16] + filename_url[17:19]
    newcard.filename_url = shortened_url
    print(shortened_url)
    newcard.save()
'''
