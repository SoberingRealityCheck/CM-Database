...
class Test_Details(models.Model):
    ...
    failure_information = models.EmbeddedField(model_container = Failure_Information)
...
class Test(models.Model):
    for test_type in test_list:
        test_type = models.EmbeddedField(model_container = Test_Details)
